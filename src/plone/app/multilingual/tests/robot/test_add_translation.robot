...
I link the document in English as a translation
  ...
  Focus  xpath=(//*[@class="table-striped"]//a[contains(@href,"a-catalan-document")])
  Click Element  xpath=(//*[@class="table-striped"]//a[contains(@href,"a-catalan-document")])
  Wait until page contains  A Catalan Document
...
I can view the document in English
  ...
  ...  xpath=//h1[1]/text()='An English Document'
  Wait until page contains element
